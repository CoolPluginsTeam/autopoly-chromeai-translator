...
class ClassicTranslationTooltip {
    constructor(contentTinyMCE) {
        ...
        this.reactRoot = null;
        this.prefix='atfpClassicInlineTranslation';
        this.toolTipTop=0;
        this.toolTipLeft=0;
    ...
    init() {
        ...
        this.contentTinyMCE.on('selectionchange', () => {
            ...
            if (!this.reactRoot) {
                this.reactRoot = ReactDOM.createRoot(document.getElementById('atfp-classic-inline-translation'));
            }
...
jQuery(window).on('load', function () {
    if(typeof tinymce !== 'undefined' && tinymce) {
        ...
        if(contentTinyMCE){
            ...
            wrapperElement.id = 'atfp-classic-inline-translation';
